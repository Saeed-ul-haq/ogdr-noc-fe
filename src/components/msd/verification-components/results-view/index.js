...
const MapResult = ({
  ...
  const [radius, setRadius] = useState(resultRadius || 15)
  ...
  const radiusChanger = (
    <div>
      ...
      <Button
        type="primary"
        onClick={() => updateResultRadius(radius)}
        style={{ padding: '0 53px', margin: '20px' }}
      >
        {i18n.t(l.apply)}
      </Button>
    </div>
        ...
        <section className="results-section-main--list">
          <section className="results-section-header">
            ...
            <div className="item-font">
              <Popover
                placement="topLeft"
                title={`${i18n.t(l.change_radius)}`}
                content={radiusChanger}
                trigger="click"
              >
